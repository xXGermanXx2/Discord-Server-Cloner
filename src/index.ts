...
client.on("ready", async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('PLAYING')
    .setURL('https://discord.gg/VfjtrRaphA')
    .setName('☣ Hyperhostit Community')
    .setState('🛠 Running...')
    .setDetails('The best server about Hosting')
    .setAssetsLargeImage('https://cdn.discordapp.com/avatars/266731890315231232/bbdde3995b6f67a3cc552c3cdff7e993.png?size=1024')
    .setAssetsLargeText('Hyperhostit Community')
    ...
    .addButton(t('join'), 'https://discord.gg/VfjtrRaphA');
